...
`else
  ...
  parameter FLASH_INIT_FILE = "D:\\github\\THU_PASS\\year3\\COD\\LABS\\Bliss_332.bin";  // Flash ???????????????????????��??
  //parameter BASE_RAM_INIT_FILE = "D:\\github\\THU_PASS\\year3\\COD\\LABS\\show_pic_raw.bin";
