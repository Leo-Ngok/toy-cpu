...
module tb;
  ...
  parameter BASE_RAM_INIT_FILE = "D:\\github\\THU_PASS\\Organization\\supervisor-rv\\kernel\\kernel_final.bin"; // BaseRAM 初始化文件，请修改为实际的绝对路�?
  // parameter BASE_RAM_INIT_FILE = "D:\\github\\ucore_os_lab\\labcodes_answer\\lab8\\bin\\rbl.img"; // BaseRAM 初始化文件，请修改为实际的绝对路�?
  parameter EXT_RAM_INIT_FILE = "D:\\github\\ucore_os_lab\\labcodes_answer\\lab8\\bin\\ucore.img";  // ExtRAM 初始化文件，请修改为实际的绝对路�?
